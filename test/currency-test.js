...
//var cur = currency.from_human('VBC', false);
//console.log(cur.is_native())
//console.log(cur.to_hex())
//console.log('---',cur._iso_code)
//var cur = currency.from_hex('000000000000000000000000424B410000000000');
//console.log(cur.to_json())
//var cur = currency.from_hex('00000000000000000000000000000000000000FF');
//console.log(cur.to_json())

takergets = amount.from_json({
    "currency": "VBC",
    "issuer": "rrrrrrrrrrrrrrrrrrrrVFngv46",
    "value": "181840"
});

console.log(takergets.is_valid())
console.log(takergets._currency)
console.log(takergets.is_native())
console.log(takergets.to_json())
